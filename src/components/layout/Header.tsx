  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#1a1a1a] h-[68px] flex items-center justify-between px-4"
        ...
        {/* Hamburger gauche — anime en croix a l'ouverture */}
        <button
        ...
        >
          <span
            className="block w-[18px] h-px bg-white transition-transform duration-300 ease-in-out"
            style={{ transform: menuOpen ? 'translateY(6px) rotate(45deg)' : 'translateY(0) rotate(0deg)' }}
          />
          <span
            className="block w-[18px] h-px bg-white transition-opacity duration-200 ease-in-out"

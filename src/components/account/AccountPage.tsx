          ...
          <div className="flex flex-col gap-3">
            {orders.length === 0 ? (
              <div className="text-center py-12">
                ...
                <Link href={`/${locale}/collections`} className="font-sans text-[11px] tracking-[0.15em] uppercase underline underline-offset-4 text-black mt-3 inline-block no-underline">

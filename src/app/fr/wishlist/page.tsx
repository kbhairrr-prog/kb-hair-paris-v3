...
export default function WishlistFR() {
    ...
    <>
      ...
      <main className="min-h-screen bg-white pt-[68px]">
        <div className="bg-[#f0f0f0] border-b border-[#e0e0e0] px-5 py-8 text-center">
          <p className="font-sans text-[10px] tracking-[0.3em] uppercase text-[#888] mb-2">Ma liste</p>
                ...
                return (
                  <div key={product.id} className="bg-white group relative">
                    ...
                    <button
                      ...
                      className="absolute top-2 left-2 z-10 w-7 h-7 bg-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity border-none cursor-pointer shadow-sm"
                    >
                    ...
                    <button
                      ...
                      className="w-full bg-black text-white font-sans text-[10px] tracking-[0.18em] uppercase py-3 border-none cursor-pointer hover:opacity-85 transition-opacity"
                    >
                      AJOUTER AU PANIER
                    </button>
                  </div>
